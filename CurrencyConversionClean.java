...
public class CurrencyConversionClean {
    ...
    public static double findBestConversionRate(double[][] adjacencyMatrix, int sourceCurrencyIndex, int targetCurrencyIndex, int[] predecessors, boolean checkArbitrage) {
        // double[][] transGraph = negateLogarithmConverter(adjacencyMatrix);
        // 4
    ...
    public static void main(String[] args) {
        ...
        //TODO: Test Case 1
        // TODO: This shows the best currency conversion for all currencies
        double[][] adjacencyMatrix = {
        ...
        // double[][] adjacencyMatrix = {
        //     {0, 0.935109, 0.589402, 0.488496}, // NZD to AUD, USD, GBP
        //     {1.069329, 0, 0.630265, 0.522328},   // AUD to NZD, USD, GBP
        //     {1.696699, 1.586830, 0, 0.828845},  // USD to NZD, AUD, GBP
        //     {2.046911, 1.914217, 1.206436, 0}   // GBP to NZD, AUD, USD
        // };
        

       // Apply the negative logarithm transformation to the adjacency matrix
        for (int i = 0; i < adjacencyMatrix.length; i++) {
            for (int j = 0; j < adjacencyMatrix[i].length; j++) {
                if (adjacencyMatrix[i][j] != 0) {
                    adjacencyMatrix[i][j] = -Math.log(adjacencyMatrix[i][j]);
                }
            }
        }
        
        // TODO: Arbitrage cycle test code
        double[][] adjacencyMatrix1 = {
        ...
        // TODO: Negative cycle test code
        // double[][] adjacencyMatrix = {
        //     {1, 2, 3},  // Currency A to B, C
        //     {3, 1, 2},  // Currency B to A, C
        //     {2, 3, 1}   // Currency C to A, B
        // };
        ...
        String[] currencies1 = {"A", "B", "C", "D"};

        boolean arbitrageDetected1 = testCurrencyConversion(adjacencyMatrix1, currencies1);

        if (!arbitrageDetected1) {
            System.out.println("\nNo arbitrage opportunities found.\n");
        }
    ...
    public static boolean testCurrencyConversion(double[][] adjacencyMatrix, String[] currencies) 
    {
            ...
            for (int targetCurrencyIndex = 0; targetCurrencyIndex < currencies.length; targetCurrencyIndex++) {
                if (sourceCurrencyIndex != targetCurrencyIndex) {
                    ...
                    if (bestConversionRate == -1) {
                        ...
                        System.out.print(currencies[sourceCurrencyIndex] + " <- ");
        ...
        // System.out.println("The for loop doesnt work");
        return arbitrageDetected;
    }   
